...
//    }
//
//    private <T, M, R> R twoFunc(int threads, List<? extends  T> values, Function<Stream<? extends T>, M> process1, Function<Stream<? extends M>, R> process2) throws InterruptedException {
//        return process2.apply(firstFunc(threads, values, process1).stream());
//    }
//
//    private <T, M> List<M> firstFunc(int threads, List<? extends  T> values, Function<Stream<? extends T>, M> process1) throws InterruptedException {
